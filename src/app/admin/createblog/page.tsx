...
function CreateBlog() {
  ...
  const handle = async (data: Record<string, any>) => {
    ...
    if (rs.data.err === 0) {
      Swal.fire("Chúc mừng!", "Đăng blog thành công", "success").then(() => {
        setLoad(false);
        setPayload({
          title: "",
  ...
  return (
    <div className="flex flex-col justify-center items-center bg-[#212121]">
      <div className="w-4/5 flex flex-col items-center">
        <div className="containers my-14 rounded-md">
          <div className="form">
            <h2 className="text-3xl font-bold text-center">Đăng Blog</h2>
